...
A full-stack web application designed for managing hotel room reservations. This project features a classic Django web interface for server-side rendered pages alongside a Django REST Framework (DRF) API for client consumption.

> **Live Demo:** [View on Koyeb](https://bloody-nonna-amoebae-938ffef2.koyeb.app/accounts/login/)
> **Swagger:** [View on Koyeb](https://bloody-nonna-amoebae-938ffef2.koyeb.app/api/docs/)
