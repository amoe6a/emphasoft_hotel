...
class RoomFilterTest(TestCase):
    ...
    def setUp(self):
        ...
        self.room_small = Room.objects.create(name="101", price_per_night=1000, capacity=2)
        self.room_large = Room.objects.create(name="102", price_per_night=2000, capacity=4)
        self.room_mid = Room.objects.create(name="103", price_per_night=1500, capacity=2)
